...
function fish_git_prompt --description "Prompt function for Git"
	...
	if not git diff-index --quiet HEAD -- 2>/dev/null
		set branch_color $___fish_git_prompt_color_branch_dirtystate
	end
	if not git diff-index --cached --quiet HEAD -- 2>/dev/null
		set branch_color $___fish_git_prompt_color_branch_stagedstate
	end
	if command git ls-files --others --exclude-standard --directory --no-empty-directory --error-unmatch -- :/ >/dev/null 2>&1
		set branch_color $___fish_git_prompt_color_branch_untrackedstate
	end
...
function __fish_git_prompt_validate_colors --description "fish_git_prompt helper, checks color variables"
	...
	__fish_git_prompt_set_color __fish_git_prompt_color_branch_dirtystate
	__fish_git_prompt_set_color __fish_git_prompt_color_branch_stagedstate
	__fish_git_prompt_set_color __fish_git_prompt_color_branch_untrackedstate
